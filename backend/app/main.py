...
from app.api import trend, sector, symbol, search, admin, admin_panel, auth, portfolio, superstrength, watchlist, cup_handle
...
app.include_router(cup_handle.router,     prefix="/api/cup-handle", tags=["Cup & Handle"])
